...
public:
	...
	void SetLowerThreshold(std::vector<double> &params, bool testOnly=false);
	void GetLowerThreshold(std::vector<double> &params, bool testOnly=false);

	void SetUpperThreshold(std::vector<double> &params, bool testOnly=false);
	void GetUpperThreshold(std::vector<double> &params, bool testOnly=false);
	...
	void RequestCalibrate(std::vector<double> &params, bool testOnly=false);
