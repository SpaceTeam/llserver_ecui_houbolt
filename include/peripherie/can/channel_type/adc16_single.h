#ifndef PERIPHERIE_CAN_CHANNEL_TYPE_ADC16_SINGLE_H
#define PERIPHERIE_CAN_CHANNEL_TYPE_ADC16_SINGLE_H
...
namespace peripherie::can::channel_type {
	class adc16_single : public channel {
	private:
...
#endif /* PERIPHERIE_CAN_CHANNEL_TYPE_ADC16_SINGLE_H */
