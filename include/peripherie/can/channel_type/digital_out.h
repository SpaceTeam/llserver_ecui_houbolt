#ifndef PERIPHERIE_CAN_CHANNEL_TYPE_DIGITAL_OUT_H
#define PERIPHERIE_CAN_CHANNEL_TYPE_DIGITAL_OUT_H
...
namespace peripherie::can::channel_type {
	class digital_out : public channel {
	private:
...
#endif /* PERIPHERIE_CAN_CHANNEL_TYPE_DIGITAL_OUT_H */
