...
{
    commandMap = {
        {"SetRefreshDivider", std::bind(&ADC24::SetRefreshDivider, this, std::placeholders::_1, std::placeholders::_2)},
        {"GetRefreshDivider", std::bind(&ADC24::GetRefreshDivider, this, std::placeholders::_1, std::placeholders::_2)},
        {"SetLowerThreshold", std::bind(&ADC24::SetLowerThreshold, this, std::placeholders::_1, std::placeholders::_2)},
        {"GetLowerThreshold", std::bind(&ADC24::GetLowerThreshold, this, std::placeholders::_1, std::placeholders::_2)},
        {"SetUpperThreshold", std::bind(&ADC24::SetUpperThreshold, this, std::placeholders::_1, std::placeholders::_2)},
