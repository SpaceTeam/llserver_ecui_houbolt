...
{
    commandMap = {
        {"SetState", std::bind(&DigitalOut::SetState, this, std::placeholders::_1, std::placeholders::_2)},
        {"GetState", std::bind(&DigitalOut::GetState, this, std::placeholders::_1, std::placeholders::_2)},
        {"SetDutyCycle", std::bind(&DigitalOut::SetDutyCycle, this, std::placeholders::_1, std::placeholders::_2)},
        {"GetDutyCycle", std::bind(&DigitalOut::GetDutyCycle, this, std::placeholders::_1, std::placeholders::_2)},
        {"SetFrequency", std::bind(&DigitalOut::SetFrequency, this, std::placeholders::_1, std::placeholders::_2)},
        {"GetFrequency", std::bind(&DigitalOut::GetFrequency, this, std::placeholders::_1, std::placeholders::_2)},
        {"SetRefreshDivider", std::bind(&DigitalOut::SetRefreshDivider, this, std::placeholders::_1, std::placeholders::_2)},
