...
{
	std::cout << "CANDriverSocketCAN::CANDriverSocketCAN" << std::endl;
//    canStatus stat;
...
{
	std::cout << "CANDriverSocketCAN::SendCANMessage" << std::endl;
...
std::map<std::string, bool> CANDriverSocketCAN::GetCANStatusReadable(uint32_t canBusChannelID)
{
	std::cout << "CANDriverSocketCAN::GetCANStatusReadable" << std::endl;
...
// if not needed
//void CANDriverSocketCAN::OnCANCallback(int handle, void *driver, unsigned int event)
//{
...
//std::string CANDriverSocketCAN::CANError(canStatus status)
//{
//    char msg[64];
...
//canStatus CANDriverSocketCAN::InitializeCANChannel(uint32_t canBusChannelID)
//{
//    canStatus stat;
