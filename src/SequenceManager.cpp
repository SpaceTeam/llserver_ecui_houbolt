...
//
//nlohmann::json SequenceManager::jsonSequence = nlohmann::json::object();
//nlohmann::json SequenceManager::jsonAbortSequence = nlohmann::json::object();
...
//            (jsonAbortSequence["globals"]["endTime"].type() == nlohmann::json::value_t::number_float))
//        {
